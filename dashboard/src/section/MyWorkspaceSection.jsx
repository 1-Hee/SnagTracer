...
const MyWorkspaceSection = () => {
  ...
  const loadWorkspaces = async () => {
    ...
    const fetchedWorkspaces = [
      { workId: 1, title: 'Workspace 1', leader: 'Alice', memberCount: 3, issueCount: 2, participantCount: 5, issue: { issueId:1234, title: 'Login Issue', date: '2025-04-01', author: 'User 1', content: 'Cannot login' } },
      { workId: 2, title: 'Workspace 2', leader: 'Bob', memberCount: 4, issueCount: 1, participantCount: 6, issue: {  issueId:5678, title: 'API Error', date: '2025-04-02', author: 'User 2', content: 'API is down' } }
    ];
